...
<style>
    ...
    /* =========================================================================
       HIDE STREAMLIT COMMUNITY CLOUD: SHARE, FAVORITE (STAR), AND EDIT (PENCIL)
       PRESERVE: GITHUB REPO ICON AND 3-DOTS (MAIN MENU)
       ========================================================================= */

    /* 1. Hide Deploy and Share Button */
    .stDeployButton,
    ...
    button[aria-label*="Share" i],
    button[title*="Share" i],
    header div:has(> button[title*="share" i]),
    header div:has(> button[aria-label*="share" i]),

    /* 2. Hide Favorite (Star) Button */
    ...
    button[aria-label*="Star" i],
    button[title*="Star" i],
    header div:has(> button[title*="favorite" i]),
    header div:has(> button[title*="star" i]),

    /* 3. Hide Edit (Pencil) Button */
    ...
    a[title*="Edit" i],
    a[href*="/edit"],
    header div:has(> a[href*="/edit"]),
    header div:has(> button[title*="edit" i]),

    /* 4. Filter elements within the header action toolbar */
    [data-testid="stHeaderActionElements"] button[title*="share" i],
    [data-testid="stHeaderActionElements"] button[aria-label*="share" i],
    [data-testid="stHeaderActionElements"] button[title*="Share" i],
    [data-testid="stHeaderActionElements"] button[aria-label*="Share" i],
    [data-testid="stHeaderActionElements"] button[title*="favorite" i],
    [data-testid="stHeaderActionElements"] button[aria-label*="favorite" i],
    [data-testid="stHeaderActionElements"] button[title*="star" i],
    [data-testid="stHeaderActionElements"] button[aria-label*="star" i],
    [data-testid="stHeaderActionElements"] button[title*="Star" i],
    [data-testid="stHeaderActionElements"] button[aria-label*="Star" i],
    [data-testid="stHeaderActionElements"] button[title*="edit" i],
    [data-testid="stHeaderActionElements"] button[aria-label*="edit" i],
    [data-testid="stHeaderActionElements"] button[title*="Edit" i],
    [data-testid="stHeaderActionElements"] button[aria-label*="Edit" i],
    [data-testid="stHeaderActionElements"] a[title*="edit" i],
    [data-testid="stHeaderActionElements"] a[aria-label*="edit" i],
    [data-testid="stHeaderActionElements"] a[href*="/edit"],
    [data-testid="stHeaderActionElements"] div:has(> a[href*="/edit"]),
    [data-testid="stHeaderActionElements"] div:has(> button[title*="share" i]),
    [data-testid="stHeaderActionElements"] div:has(> button[title*="star" i]),
    [data-testid="stHeaderActionElements"] div:has(> button[title*="edit" i]) {
        display: none !important;
    ...
    /* 5. Positional fallback: Hide first 3 buttons in the toolbar */
    [data-testid="stHeaderActionElements"] > button:not([data-testid="stMainMenu"]):not([title*="GitHub" i]):not([aria-label*="GitHub" i]):not([title*="source" i]):not([aria-label*="source" i]):not(:has(a[href*="github.com"])):not(:last-child),
    [data-testid="stHeaderActionElements"] > div:not([data-testid="stMainMenu"]):not(:has(a[href*="github.com"])):not(:has([data-testid="stMainMenu"])):not(:last-child):not(:nth-last-child(2)) {
        display: none !important;
        visibility: hidden !important;
        width: 0 !important;
        height: 0 !important;
    ...
    /* 6. Explicitly preserve GitHub Icon and 3-Dots Menu */
    [data-testid="stHeaderActionElements"] a[href*="github.com"],
    [data-testid="stHeaderActionElements"] a[title*="source" i],
    [data-testid="stHeaderActionElements"] a[aria-label*="source" i],
    [data-testid="stHeaderActionElements"] button:has(a[href*="github.com"]),
    [data-testid="stHeaderActionElements"] div:has(a[href*="github.com"]),
    #MainMenu,
